...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', help = "model architecture", choices=list(_models.keys()))
    parser.add_argument('--optimizer', help= "optimizer to train a model", choices=list(_optimizers.keys()))
    ...
    expname = '_' + args.dataset + '_' + args.type + '_' + args.run_name
